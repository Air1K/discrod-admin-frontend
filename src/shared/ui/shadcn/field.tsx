  ...
  variants: {
    orientation: {
      ...
      horizontal: [
        ...
        '[&>[data-slot=field-error]]:basis-full',
        '[&>[data-slot=field-error]]:w-full',
      ],
      responsive: [
        ...
        '@md/field-group:flex-wrap',
        '@md/field-group:[&>[data-slot=field-error]]:basis-full',
        '@md/field-group:[&>[data-slot=field-error]]:w-full',
      ],
    },
  },
  defaultVariants: {
